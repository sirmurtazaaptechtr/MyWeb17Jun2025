...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $parent_id = isset($_POST['parent_id']) && $_POST['parent_id'] !== '' ? safe_input($_POST['parent_id']) : 'NULL';
    ...
    if(empty($_SESSION['errors'])) {
        $sql = "INSERT INTO `categories` (name, description, parent_id, image) VALUES ('$name', '$description', ".($parent_id === 'NULL' ? 'NULL' : "'$parent_id'").", '$image')";
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Enter Category Details</h5>
