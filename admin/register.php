...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if(isset($_FILES['profile_pic']) && $_FILES['profile_pic']['error'] == 0) {
        $profile_pic = 'assets/img/profile_pic/' . basename($_FILES['profile_pic']['name']);
    ...
    $sql = "INSERT INTO `users` (`name`, `email`, `password`, `role`, `profile_pic`) VALUES ('$name', '$email', '$hashed_password', '$role', '$profile_pic')";
                                    ...
                                    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post"
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="file" name="profile_pic" class="form-control" id="profilePic"
                                                accept="image/*">
                                            <div class="form-text">Optional - Upload your profile photo</div>
                                        </div>
